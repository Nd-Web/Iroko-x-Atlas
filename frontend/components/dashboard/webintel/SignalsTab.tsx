...
const SignalCard: FC<{ signal: Signal; category: SignalCategory }> = ({
  ...
  return (
    ...
    >
      ...
      {isHigh && (
        <div
          className="absolute inset-0 rounded-xl pointer-events-none shadow-[inset_0_0_0_1px_rgba(239,68,68,0.15)]"
          aria-hidden="true"
        />
      )}
    </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          {isMock ? (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10.5px] font-bold uppercase tracking-wide bg-[rgba(245,158,11,0.12)] border border-[rgba(245,158,11,0.35)] text-[#F59E0B]">
