 ...
 *   2. Verdict & Compliance — NCC compliance checker + PDF brief download
...
const ComplianceTab: FC = () => {
  ...
  const handleDownloadBrief = async () => {
    ...
    try {
      ...
      a.href     = url;
      a.download = `iroko-compliance-brief-${new Date().toISOString().slice(0, 10)}.pdf`;
      a.click();
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-[11px] mt-0.5" style={{ color: "#6B7280" }}>
                Evaluate a decision against the live NCC regulatory corpus
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="Describe a decision or planned action for compliance review…&#10;&#10;e.g. &quot;We plan to increase interconnect rates for Airtel Nigeria by 12% effective Q2 2025 under Section 5 of the NCC QoS guidelines.&quot;"
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[13px] mt-0.5" style={{ color: "#6B7280" }}>
                Boardroom-ready intelligence for Nigerian telecoms — powered by Bright Data
              </p>
            </div>
          </div>
