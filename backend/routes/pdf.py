...
async def generate_detailed_pdf(request: PdfGenerateRequest):
    try:
        ...
        CRITICAL: You MUST include a dedicated 'NCC Compliance & Regulatory Assessment' section that evaluates the query and response against Nigerian Communications Commission (NCC) regulations, flagging any potential NO-GO or MONITOR conditions.
