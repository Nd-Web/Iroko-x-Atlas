...
Usage in agents and routes::
    ...
    result = await debate_agent.debate_signal(
        signal={
            "title":       "Carbon MFB fined for CAR breach",
            "description": "CBN issued a ₦2bn fine to Carbon MFB for capital adequacy violation ...",
        },
        context="Carbon MFB's CAR dropped below the 10% CBN minimum threshold.",
    )
