...
Iroko AI enterprise web-intelligence pipeline:
  ...
  - **Scraping Browser** (scraping_browser_interact) : Full Playwright browser
    automation over CDP for JS-heavy interactive pages (NCC.gov.ng regulatory
    document pages that require clicks, scrolls, and dynamic pagination).
...
Usage::
    ...
    results = await bright_data_client.serp_search("MTN Nigeria tariff 2025")
...
class BrightDataClient:
    ...
    async def serp_search(
        ...
        ----------
        query : str
            Search query string (e.g. "MTN Nigeria 5G rollout 2025").
        country : str
    ...
    async def scrape_structured(self, url: str, schema: dict[str, Any]) -> dict[str, Any]:
        ...
        schema : dict
            Field extraction schema, e.g.::
                ...
                {
                    "company_name": "Name of the telecom company",
                    "revenue_usd": "Annual revenue in USD",
                    "subscribers_m": "Total subscribers in millions",
                }
    ...
    async def scraping_browser_interact(self, url: str, actions: list[dict] = None) -> dict[str, Any]:
        ...
        Used for NCC.gov.ng dynamic regulatory document pages.
        """
