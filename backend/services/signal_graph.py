...
# Known fintech / regulatory entities to match against signal text
...
# Regex patterns for CBN/SEC regulation references
...
def _extract_entities(text: str) -> list[tuple[str, str]]:
    ...
    Fintech/regulatory entity names are matched via simple substring search
    against ``_KNOWN_COMPANIES``; regulation references via ``_REGULATION_PATTERN``.
