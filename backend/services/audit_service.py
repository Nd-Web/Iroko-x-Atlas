...
CBN/SEC compliance context:
    - ``generate_compliance_report`` groups decisions by CBN/SEC regulation
...
Usage::
    ...
    entry = await AuditService.log_decision(
        ...
        decision_summary="CBN AML/CFT threshold breached — STR filing gap detected.",
        ncc_ref="CBN-AML-001",
        ncc_section="Section 15",
        confidence=0.93,
        verdict="NO-GO",
