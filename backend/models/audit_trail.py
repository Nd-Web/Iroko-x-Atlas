...
CBN/SEC compliance context:
  - ``ncc_regulation_ref`` ties each agent decision to a specific CBN/SEC
    regulation ID (e.g. "CBN-AML-001") — variable name retained for compat.
...
class AuditTrailEntry(Base):
    ...
    # ── CBN/SEC compliance references (column names retained for backward compat) ──

    ncc_regulation_ref: Optional[str] = Column(
        String,
        nullable=True,
        index=True,
        doc="CBN/SEC regulation identifier, e.g. 'CBN-AML-001', 'SEC-001'. "
