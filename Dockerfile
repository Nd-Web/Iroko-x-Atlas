...
# playwright install --with-deps installs Chromium + all OS-level deps using
# Playwright's own manifest, which handles Debian Bookworm package renames correctly.
